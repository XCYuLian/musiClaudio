...
async function buildContext(opts = {}) {
  ...
  const systemPrompt = [
    ...
    '70% of your `play` recommendations MUST be NEW songs NOT in their playlist — hidden gems matching their DNA.',
    '30% may be familiar tracks from their playlist — comfort picks.',
    'Per batch of 5: aim for 3-4 new discoveries + 1-2 familiar tracks.',
    'When recommending new tracks, say "为你挖掘了一首宝藏" or similar. For familiar ones, say "这首来自你的歌单"。',
    '',
